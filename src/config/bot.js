...
const SETTINGS_REGISTRY = {
	...
	'birthday-ping-everyone': { env: 'BIRTHDAY_PING_EVERYONE', type: 'boolean', default: false, description: 'Mention @everyone in birthday announcements', configKey: 'birthdayPingEveryone' },
	'birthday-ping-here':    { env: 'BIRTHDAY_PING_HERE', type: 'boolean', default: false, description: 'Mention @here in birthday announcements', configKey: 'birthdayPingHere' },
	'birthday-ping-role':    { env: 'BIRTHDAY_PING_ROLE', type: 'snowflake', default: null, description: 'Role to mention in birthday announcements', configKey: 'birthdayPingRole' },
	'birthday-ping-user':    { env: 'BIRTHDAY_PING_USER', type: 'boolean', default: false, description: 'Mention the celebrated user above the embed', configKey: 'birthdayPingUser' },
	'birthday-role':         { env: 'BIRTHDAY_ROLE', type: 'snowflake', default: null, description: 'Role assigned to members on their birthday', configKey: 'birthdayRole' },
};
